...
if(UNITTEST )
	...
	target_link_libraries(${PROJECT_NAME}_t ${PROJECT_NAME} gtest_main)
        set_target_properties(${PROJECT_NAME}_t PROPERTIES RUNTIME_OUTPUT_DIRECTORY_DEBUG ${TEST_OUTPUT_PATH})
        set_target_properties(${PROJECT_NAME}_t PROPERTIES RUNTIME_OUTPUT_DIRECTORY_RELEASE ${TEST_OUTPUT_PATH})
        ...
        if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/test/config/conf.cmake)
                message("configure test " ${PROJECT_NAME}_t)
